...
enum ExprK {ID_EXPR, OP_EXPR, CONST_EXPR, STRINGLIT_EXPR, LIST_EXPR, LISTLEN_EXPR, FUNC_EXPR};
enum StmtK {PRINT_STMT, IF_STMT, LOOP_STMT, ASSIGN_STMT, DEF_STMT, PUSH_STMT, POP_STMT, RETURN_STMT};
